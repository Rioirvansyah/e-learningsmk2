                        ...
                        <form action="proses_tambah-ujian-detail.php?aksi=update" method="post" class="form-horizontal" enctype="multipart/form-data">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-10">
                                <select name="jenis_soal" class="standardSelect" onchange="if (this.selectedIndex==1) {document.getElementById('tampil_jenis_soal').style.display='inline'}else {document.getElementById('tampil_jenis_soal').style.display='none'}" required="">
                                    <option value=""></option>
