...
CREATE TABLE `jawaban_siswa` (
  `id_jawaban_siswa` varchar(100) COLLATE latin1_general_ci NOT NULL,
  `id_ujian_online` varchar(100) COLLATE latin1_general_ci NOT NULL,
  `no_induk` varchar(100) COLLATE latin1_general_ci NOT NULL,
  `no_soal` varchar(100) COLLATE latin1_general_ci NOT NULL,
  `jawaban` varchar(100) COLLATE latin1_general_ci NOT NULL,
  `status_jwb` varchar(100) COLLATE latin1_general_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
CREATE TABLE `nilai_ujian` (
  ...
  `id_ujian_online` varchar(100) COLLATE latin1_general_ci NOT NULL,
  `no_induk` varchar(100) COLLATE latin1_general_ci NOT NULL,
  `nilai_total` varchar(100) COLLATE latin1_general_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
(1, 'UO-00001', 1, 'Jelaskan apa yang dimaksud e-elearning !', 'Essay', '', '', '', '', '', '', '', '10'),
